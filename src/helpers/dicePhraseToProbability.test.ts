...
it('works with input 3', () => {
  const output = dicePhraseToProbability('3')
...
it('works with input D6', () => {
  const output = dicePhraseToProbability('D6')
...
it('works with input 2D3', () => {
  const output = dicePhraseToProbability('2D3')
...
it('works with input D3+3', () => {
  const output = dicePhraseToProbability('D3+3')
