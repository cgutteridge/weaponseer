...
// step props: () -- no props
export default function processStepRollToFeelNoPain (props: string[], steps: string[], defState: string[], defenders: Defender[]): Spread<string> {
  ...
  let spread: Spread<number> = [
    { item: 0, probability: always() }
  ]
